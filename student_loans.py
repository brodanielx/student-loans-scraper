...
loan_detail_divs = soup.find_all("div", class_="detail")

loan_status_uls = soup.find_all("ul", title="Loan Status")
disbursement_info_uls = soup.find_all("ul", title="Disbursement Information")

print(disbursement_info_uls[0].contents)
# print([ul.getText() for ul in disbursement_info_uls])